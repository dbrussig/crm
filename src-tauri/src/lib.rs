...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::crm::upsert_accessory_calendar_mapping,
            commands::crm::delete_accessory_calendar_mapping,
            commands::crm::list_accessory_calendar_mappings,
            commands::crm::upsert_accessory_calendar_event,
            commands::crm::delete_accessory_calendar_events_for_invoice,
            commands::crm::list_accessory_calendar_events_for_invoice,
            commands::crm::list_accessory_calendar_events_range,
